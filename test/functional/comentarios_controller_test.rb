...
class ComentariosControllerTest < ActionController::TestCase
  ...
  test "should create comentario" do
    assert_difference('Comentario.count') do
      post :create, comentario: { data: @comentario.data, texto: @comentario.texto, tipo: @comentario.tipo, titulo: @comentario.titulo }
    end
  ...
  test "should update comentario" do
    put :update, id: @comentario, comentario: { data: @comentario.data, texto: @comentario.texto, tipo: @comentario.tipo, titulo: @comentario.titulo }
    assert_redirected_to comentario_path(assigns(:comentario))
  end
